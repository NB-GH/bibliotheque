...
/**
 * Fenêtre principale de l'application de gestion de bibliothèque Contient les
 * différentes vues organisées sous forme d'onglets : livres, adhérents et
 * emprunts.
 */
public class BibliothequeFrame extends JFrame {
	...
	/**
	 * Constructeur de la fenêtre principale Initialise l'interface graphique, les
	 * onglets et les liens entre les différentes vues
	 */
